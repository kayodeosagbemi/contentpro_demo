...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>ABM Academy..::.. Fashion Academy</title>
		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center justify-content-between">
				<div class="home-banner-content col-lg-6 col-md-6">
					...
					<p>Helping Sewing enthusiasts improve on their skills through intensive and detailed virtual classes.</p>
	...
	<section class="screenshot-area section-gap-top">
		<div class="container">
			<div class="row d-flex justify-content-center">
				<div class="col-lg-6">
					<div class="section-title text-center">
						<h2>Some Things Our Students Have Made</h2>
						<p>View samples of what students (like you!) have made after they finished our courses
						</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="owl-carousel owl-screenshot">
					<div class="single-screenshot">
						<img class="img-fluid" src="img/screenshots/sample_1.png" alt="">
					</div>
					<div class="single-screenshot">
						<img class="img-fluid" src="img/screenshots/sample_2.png" alt="">
					</div>
					<div class="single-screenshot">
						<img class="img-fluid" src="img/screenshots/sample_3.png" alt="">
					</div>
					<div class="single-screenshot">
						<img class="img-fluid" src="img/screenshots/sample_4.png" alt="">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="col-lg-6">
					<div class="section-title text-center">
						...
						<p>Pick a pricing plan and browse
						</p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-price">
						<div class="top-sec d-flex justify-content-between">
							<div class="top-left">
								<h4>Quick Start</h4>
								<p>For <br>Newly-minted learners</p>
							</div>
							<div class="top-right">
								<h1>N1990</h1>
							</div>
						...
						<div class="end-sec">
							<ul>
								...
								<li>Access to Instagram Group</li>
								<li>You can stream or download courses</li>
							</ul>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-price">
						<div class="top-sec d-flex justify-content-between">
							<div class="top-left">
								<h4>Detailed Start</h4>
								<p>For <br>intermediate learners</p>
							</div>
							<div class="top-right">
								<h1>N2500</h1>
							</div>
